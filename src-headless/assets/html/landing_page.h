...
<head>
    ...
    <title>APEX Headless | Advanced Penetration Toolkit</title>
    ...
    <div class="main">
        <div class="header">
            <div class="glitch-container">
                <h1 class="title">APEX Headless</h1>
            </div>
            <p class="tagline typing">// Advanced Penetration & EXploitation //</p>
        ...
        <div class="footer">
            ...
            <div class="footer-bottom">
                <div>APEX Network © 2023 | Designed for security professionals | Use responsibly</div>
