...
<head>
    ...
    <title>APEX Setup | Initial Configuration</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="setup-container">
            <h1 class="setup-title">APEX Initial Setup</h1>
            ...
            <form action="/saveconfig" method="POST">
                <div class="setup-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ssid" name="ssid" class="form-input" value="apex" required>
        ...
        <div class="setup-footer">
            APEX Setup Wizard | Version 1.0.0
        </div>
    </div>
