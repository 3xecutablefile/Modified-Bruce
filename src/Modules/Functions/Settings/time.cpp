...
static const String sAPEXFacts[] = {
"APEX: Multi-tool security device",    "ESP32-based penetration testing tool",
...
static const int FACT_COUNT = sizeof(sAPEXFacts) / sizeof(sAPEXFacts[0]);
...
static void drawScreensaver(TFT_eSPI& tft) {
    ...
    tft.setTextSize(1);
    tft.setTextColor(COL_TXT, COL_BG);
    String fact = sAPEXFacts[sCurrentFact];
