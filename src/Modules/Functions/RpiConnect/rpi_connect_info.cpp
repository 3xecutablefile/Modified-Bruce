...
"## Overview",
"",
"**APEX Raspberry Pi Connect** (\"RPi Connect\") is a networking feature in **m-Firmware** that uses Wi-Fi and Bluetooth to create secure, ad-hoc links between your Raspberry Pi devices. With RPi Connect you can:",
"",
"* Establish **peer-to-peer (P2P)** connections between APEX devices.",
...
"* **Discover, manage, and control** fleets of Pis running the APEX RPi Connect client.",
"",
...
"* Scan for Pis running the **APEX RPi Connect client**.",
...
"",
"```bash",
"sudo apex-connect enable",
"",
"# Discover nearby devices",
"apex-connect scan",
"",
"# Pair as controller to a host",
"apex-connect pair <device-id> --role controller",
"",
"# Open a terminal session",
"apex-connect shell <device-id>",
"",
"# Send a file",
"apex-connect send ./build/artifact.tar.gz --to <device-id>",
"",
"# Bring up the mesh",
"apex-connect mesh up",
"",
"# Start BLE scanning (optional)",
"apex-connect ble scan --uuid FFE0 --tag field-kit",
"```",
"",
...
"| Fleet | Discover/control APEX Pis | Group actions & updates |",
"",
"---",
"",
"## Architecture",
...
"apex-connect scan [--tag <tag>] [--ble] [--wifi]",
"",
"# Pair to a device and set role",
"apex-connect pair <device-id> --role <host|controller|dual>",
"",
"# Send/receive files",
"apex-connect send <path> --to <device-id> [--ttl 3600]",
"apex-connect recv --from <device-id> --out ./incoming",
"",
"# Terminal access",
"apex-connect shell <device-id> [--record ./sessions]",
"",
"# Mesh controls",
"apex-connect mesh up",
"apex-connect mesh status",
"apex-connect mesh down",
"",
"# BLE scanning",
"apex-connect ble scan [--uuid <id>] [--cid <company>] [--tag <name>]",
"",
"# Group operations",
"apex-connect group set <tag> <device-id...>]",
"apex-connect run --tag <tag> -- \"uptime && vcgencmd measure_temp\"",
"```",
"",
"---",
"",
