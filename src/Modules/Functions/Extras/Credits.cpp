...
static const String sCreditsText[] = {
    ...
    "                 v1.0.0",
    "",
    "Based on Infiltra Firmware",
    "by the Infiltra Network team.",
    "",
    "Original Infiltra Contributors:",
    "",
    "Hecker (D3CRYPT) - Owner, CEO & Founder",
    "FTW Luke - Main Developer & Co-Owner",
    "SgtFlixy - Website assistance",
    "Abdul - Website Developer & Designer",
    "Fourier (9dl) - Website Engineer & UI Maker",
    "Msi - Headless Dev & html/css dev",
    "",
    "APEX also incorporates features from:",
    "- Bruce Firmware by pr3y",
    "- Infiltra Firmware by D3CRYPT-1"
};
