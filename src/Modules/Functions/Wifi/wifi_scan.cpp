...
static void termTick(TFT_eSPI& tft) {
  ...
  String msg;
  switch ((sTermPhase++) % 4) {
case 0: msg = "["+String(spc)+"] root@apex:/# ifconfig wlan0 up"; break;
L124: case 1: msg = "["+String(spc)+"] root@apex:/# iw scan ch " + chStr; break;
L125: case 2: msg = "["+String(spc)+"] root@apex:/# sniff --beacons --short --timeout=150ms"; break;
L126: default: msg = "["+String(spc)+"] root@apex:/# collect --results --dedupe"; break;
  }
...
static void fetchResultsIfReady(TFT_eSPI& tft) {
  ...
  addTermLineWrapped(tft, "[✓] root@apex:/# scan complete");
