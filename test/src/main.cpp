...
void displayApex()
{
  Serial.println("Displaying 'APEX' on screen...");
#ifdef M5STICK_1
  M5.Lcd.setCursor(10, 30);
  M5.Lcd.println("    ___    ____  ________  __");
  M5.Lcd.println("   /   |  / __ \/ ____/ |/ /");
  M5.Lcd.println("  / /| | / /_/ / __/  |   / ");
  M5.Lcd.println(" / ___ |/ ____/ /___ /   |  ");
  M5.Lcd.println("/_/  |_/_/   /_____//_/|_|  ");
#endif

#ifdef M5STICK_2
  M5.Display.setCursor(10, 30);
  M5.Display.println("    ___    ____  ________  __");
  M5.Display.println("   /   |  / __ \/ ____/ |/ /");
  M5.Display.println("  / /| | / /_/ / __/  |   / ");
  M5.Display.println(" / ___ |/ ____/ /___ /   |  ");
  M5.Display.println("/_/  |_/_/   /_____//_/|_|  ");
#endif
...
void setup()
{
  Serial.begin(115200);
  delay(1000);
  Serial.println("=== APEX Display Test ===");
